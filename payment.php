    ...
    <div id="id">
        ...
        <div id="jig">
            <div class="container1">
                ...
                <form>
                    <input type="radio" id="cash" name="cash" value="Cash on Delivery">
                    <label for="cash"><h6>Cash on Delivery</h6></label><br>
                    <input type="radio" id="card" name="card" value="Add a card">
                    <label for="card"><h6>Add a Card</h6></label><br>
                    <input type="radio" id="upi" name="upi" value="Pay via UPI">
                    <label for="upi"><h6>Pay via UPI</h6></label><br>
                    <div style="padding:30% 10% 3% 10%;">
